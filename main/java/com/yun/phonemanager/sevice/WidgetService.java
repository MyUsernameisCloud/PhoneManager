package com.yun.phonemanager.sevice;
...
import com.yun.phonemanager.activity.ToolActivity;
import com.yun.phonemanager.receiver.AppWidgetClean;
import com.yun.phonemanager.sevice.KillProcessService.LockKillReceiver;
...
public class WidgetService extends Service {
    ...
    public void onCreate() {
        ...
        IntentFilter filter = new IntentFilter("com.yun.clean");
    ...
    class CleanReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Toast.makeText(WidgetService.this, "清理完毕", Toast.LENGTH_SHORT).show();
            // 拿到所有在运行的进程信息，遍历进程
