...
public class AddressDisplayService extends Service {
    ...
    class MyPhoneListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (state == TelephonyManager.CALL_STATE_RINGING) {
                // 查询数据库拿到归属地
                String address = AddressDao.addressQuery(incomingNumber,mcontext);
                // 显示到屏幕
                show(address);
    ...
    class OutCallReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // 查询数据库拿到归属地
            String address = AddressDao.addressQuery(resultData,mcontext);
            // 显示到屏幕
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    int lastY = params.y;
                    //位置没有越界，就将位置坐标保存起来
                    if (lastX >= 0 && lastX <= wDwidth- view.getWidth() && lastY >= 0
