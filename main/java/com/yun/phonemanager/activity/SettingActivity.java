...
import com.yun.phonemanager.view.BaseSettingView;
import com.yun.phonemanager.view.BaseSettingView2;
...
public class SettingActivity extends BaseTouch {
    private com.yun.phonemanager.view.BaseSettingView bv_update;
    private SharedPreferences spf;
    private com.yun.phonemanager.view.BaseSettingView bsv_address;
    private com.yun.phonemanager.view.BaseSettingView bv_address_boot;
    private com.yun.phonemanager.view.BaseSettingView2 bv_address_Style;
    private com.yun.phonemanager.view.BaseSettingView2 bv_address_position;
    private com.yun.phonemanager.view.BaseSettingView2 bv_boot;
    private com.yun.phonemanager.view.BaseSettingView bv_lock;
    private com.yun.phonemanager.view.BaseSettingView bv_lock_boot;
    private com.yun.phonemanager.view.BaseSettingView bv_black;
    private com.yun.phonemanager.view.BaseSettingView bv_programdog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 拿到归属地显示开机启动的View
        //bv_address_boot = (BaseSettingView) findViewById(R.id.bv_address_boot);
        // 拿到归属地显示开机启动的View
    ...
    public void addressDisplay() {
        ...
        boolean serviceRunning = ServiceState.serviceRunning(this,
                "com.yun.phonemanager.sevice.AddressDisplayService");
        if (serviceRunning) {
            // 服务如果存在则显示勾选
 ...
 */
    ...
    public void blackAbort() {
        boolean serviceRunning = ServiceState.serviceRunning(this,
                "com.yun.phonemanager.sevice.BlackAbortService");
        if (serviceRunning) {
            // 服务如果存在则显示勾选
                        ...
                        new android.content.DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                if (check[0]) {
                                    ...
                                    spf.edit().putBoolean("addressboot", false).commit();
                                }
                                if (check[1]) {
                                    spf.edit().putBoolean("lockboot", true).commit();
                                } else {
                                ...
                                if (check[2]) {
                                    spf.edit().putBoolean("blackboot", true).commit();
                                } else {
                                    spf.edit().putBoolean("blackboot", false).commit();
                                }
                                if (check[3]) {
                                    spf.edit().putBoolean("programboot", true).commit();
                                } else {
                                    spf.edit().putBoolean("programboot", false).commit();
                                }
                            }
