...
import com.yun.phonemanager.domain.ProcessInfo;
import com.yun.phonemanager.engine.ProcessInfoProvider;
import com.yun.phonemanager.sevice.KillProcessService;
...
public class ProcessManageActivity extends Activity {
    ...
    class ProcessAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null && convertView instanceof RelativeLayout) {
                ...
                holder.tv_process_memory = (TextView) view.findViewById(R.id.tv_process_memory);
    ...
    public void clean(View v) {
        ...
        Toast.makeText(
                ...
                "杀死了" + killCount + "个进程," + "释放了"
                        + Formatter.formatFileSize(this, killmem),  Toast.LENGTH_SHORT).show();
        // 更新页面
        adapter.notifyDataSetChanged();
    }
    ...
    public void setting(View v) {
        ...
        boolean running = ServiceState.serviceRunning(this,
                "com.yun.phonemanager.sevice.KillProcessService");
        // 将配置文件中的信息复制给多选框，用来判断选项是否被选中
