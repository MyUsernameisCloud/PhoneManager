...
import com.yun.phonemanager.dao.CommonDao;
...
public class CommonNumberQueryActivity extends BaseTouch {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 创建用来查询常用号码的dao对象
        cd = new CommonDao(mcontext);
        // 拿到扩展的listview
        sp=getSharedPreferences("config",Context.MODE_PRIVATE);
        //errormsg.setText(sp.getString("path",""));
    ...
    // 自定义BaseExpandableListAdapter需要重写以下方法：
    // getChild(),getChildId(),getChildView(),getChildCount(),
    // getGroup(),getGroupCount(),getGroupId(),getGroupView(),
    // hasStableIds(),isChildSelectable()
