...
import com.yun.phonemanager.util.DipTranslateUtil;
       ...
       // gv2.setOnItemClickListener(new MyListener2());
        ...
        lv_app.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // 填充popup的自定义view
                View contentView = View.inflate(APPManageActivity.this, R.layout.item_popu, null);
                // 设置popup的大小
                ...
                // 设置popup的显示位置并且显示
                window.showAtLocation(parent, Gravity.RIGHT + Gravity.TOP, DipTranslateUtil.dip2px(APPManageActivity.this, 67),
                        location[1]);
                ...
                ll_popu_share = (LinearLayout) contentView.findViewById(R.id.ll_popu_share);
                ...
                ll_popu_open.setOnClickListener(new OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (intent!=null) {
                            ...
                            //没有则提示用户
                            Toast.makeText(APPManageActivity.this, "该应用没有启动界面", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
                /**
