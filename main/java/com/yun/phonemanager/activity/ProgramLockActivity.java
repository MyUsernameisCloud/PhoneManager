...
import com.yun.phonemanager.dao.LockDao;
...
public class ProgramLockActivity extends BaseTouch2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_unlock.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                iv_unlock.setBackgroundColor(0x33000000);
        ...
        iv_lock.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                iv_unlock.setBackgroundColor(0x33ffffff);
    ...
    public void setting(View v) {
        ...
        if (!TextUtils.isEmpty(password) && !TextUtils.isEmpty(confirm)
            ...
            fillData();
            Toast.makeText(this, "欢迎第一次使用程序锁,如需启动该功能需要在设置中心里开启,此功能在5.0以后,由于安全原因已被Google砍掉!",  Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "密码为空,或两次密码不一致",  Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void ok(View v) {
        ...
        if (!TextUtils.isEmpty(password) && MD5Utils.encode(password).equals(spf.getString("lockpassword", "")))
        {
    ...
    class MyGridadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                view = View.inflate(ProgramLockActivity.this, R.layout.item_lockprogram, null);
