package com.yun.phonemanager.engine;
...
public class APPInfoProvider {
    public static List<AppInfo> getAppInfo(Context context) {
        ...
        // 得到所有包的信息
        List<PackageInfo> list = manager.getInstalledPackages(PackageManager.MATCH_UNINSTALLED_PACKAGES);
        // 遍历所有包的信息
